% runMiniGreenhouse Run the GreenLight simulation using predefined inputs and settings
%
% Efraim Manurung, Information Technology Group, Wageningen University
% efraim.efraimpartoginahotasi@wur.nl
% efraim.manurung@gmail.com
%
% source: Katzin, D., The GreenLight Model (2020)
...
p.psi = 35.68;                     % Mean greenhouse cover slope [°]
p.aFlr = 0.83;                   % Floor area of  [m^{2}]
p.aCov = 3.43;                % Surface of the cover including side walls [m^{2}]
p.hAir = 0.6;                   % Height of the main compartment [m] (the ridge height is 6.5, screen is 20 cm below it)
p.hGh = 0.65;                  % Mean height of the greenhouse [m]
p.aRoof = 0.051;           % Maximum roof ventilation area 
