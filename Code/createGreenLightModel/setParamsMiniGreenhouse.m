...
% david.katzin1@gmail.com
    ...
    setParam(gl, 'psi', 35.68); 			        % Mean greenhouse cover slope 																	� 						23 [4]
    setParam(gl, 'aFlr', 0.83);                     % Floor area of greenhouse 																		m^{2} 					144 [1]
    setParam(gl, 'aCov', 3.43);                     % Surface of the cover including side walls                                                     m^{2} 					216.6, taking into account only the parts of the that face the corridor or the outside air (not the neighbouring compartment) [4]
    setParam(gl, 'hAir', 0.6);                      % Height of the main compartment 																m 						5.7 [4]
    setParam(gl, 'hGh', 0.74);                      % Mean height of the greenhouse 																m 						6.2 [4]
    
    setParam(gl, 'aRoof', 0.051);                   % Maximum roof ventilation area 																- 						52.2 [4]
    setParam(gl, 'hVent', 0.008);                   % Vertical dimension of single ventilation opening 												m 						0.87 [4]
    ...
    setParam(gl, 'cWgh', 0.0);                      % Ventilation global wind pressure coefficient 													-                               0.09 [1]
