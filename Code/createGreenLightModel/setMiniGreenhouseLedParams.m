function setMiniGreenhouseLedParams(gl)
% setMiniGreenhouseLedParams Modify parameters for a GreenLight, according to a dataset with LED toplighting in mini greenhouse
% Used in: 
