function [outdoor, indoor, controls, startTime] = loadMiniGreenhouseDataLeaf(firstDay, seasonLength)
...
%       indoor(:,6)     PAR In (Radiation inside)          W m^{-2}
    ...
    path = [currentFolder '\minigreenhouseleaf2.mat'];
    
    %% load hi res 
    minigreenhouse = load(path).minigreenhouseleaf2;
